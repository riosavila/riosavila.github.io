...
$$hours=b_0 + b_1 kids + b_2 educ + b_3 age + b_4 age^2 + b_5 hispanic + b_6 black+ b_7 nonmomi + u$${#eq-eq1}
...
$$totfatrte = b_0 + b_1 \mathbb{1}(seatbealt=1) + b_2 \mathbb{1}(seatbealt=2) + b_3 minage + b_3 zerotol + b_4 unem + b_5 perc14_24 + b_6 vehicmiles + e$${#eq-eq2}
