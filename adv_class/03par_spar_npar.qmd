...
## Ok but what about Semi-parametric! {.scrollable}
...
$$
    ...
    Parametric model: 
$$wage = b_0 + b_1 age + b_2 education +\varepsilon
$$
...
## Kernel density: Visualization {.scrollable}
...
## Local Constant Regression {.scrollable}
...
![](resources/image-1628248108.png){fig-align="center" width="300"}
