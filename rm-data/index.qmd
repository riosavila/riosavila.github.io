...
<head>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/opus-recorder/0.5.2/waveWorker.min.js"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/opus-recorder/0.5.2/encoderWorker.min.js"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/opus-recorder/0.5.2/decoderWorker.min.js"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/opus-recorder/0.5.2/oggopusDecoder.min.js"></script>
</head>
<body>
<div id="opus-player">
    <audio id="opusPlayer" controls>
        <source src="slides/audio/chapt_7_gg.opus" type="audio/ogg; codecs=opus">
        Your browser does not support the audio element.
    </audio>
</div>
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            var player = document.getElementById('opusPlayer');
            var oggOpusDecoder = new OggOpusDecoder();

            player.addEventListener('error', function() {
                var audioSrc = player.querySelector('source').src;
                fetch(audioSrc)
                    .then(response => response.arrayBuffer())
                    .then(buffer => oggOpusDecoder.decode(buffer))
                    .then(decodedAudio => {
                        var blob = new Blob([decodedAudio], { type: 'audio/wav' });
...
<div id="opus-player">
    <audio id="opusPlayer" controls>
        <source src="slides/audio/chapt_7_cg.opus" type="audio/ogg; codecs=opus">
        Your browser does not support the audio element.
    </audio>
</div>
```
